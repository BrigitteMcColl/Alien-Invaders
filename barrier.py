...
class Barrier(Sprite):
    block_images = [pg.image.load('images/block4.png'), pg.image.load('images/block3.png'),
                    pg.image.load('images/block2.png'), pg.image.load('images/block1.png'),
                    pg.image.load('images/block0.png')]
    block_TopL_images = [pg.image.load('images/blockTopL4.png'), pg.image.load('images/blockTopL3.png'),
                         pg.image.load('images/blockTopL2.png'), pg.image.load('images/blockTopL1.png'),
                         pg.image.load('images/blockTopL0.png')]
    block_TopR_images = [pg.image.load('images/blockTopR4.png'), pg.image.load('images/blockTopR3.png'),
                         pg.image.load('images/blockTopR2.png'), pg.image.load('images/blockTopR1.png'),
                         pg.image.load('images/blockTopR0.png')]
